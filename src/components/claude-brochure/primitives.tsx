...
// Sin "use client": se pueden usar tanto desde server components (home) como
// desde las landings cliente (/claude, /claude-no-programadores).
...
export const TerminalSnippet = ({
  ...
  <div className="mx-auto max-w-md overflow-hidden rounded-xl border border-white/10 bg-black/50 text-left shadow-[0_30px_60px_-30px_rgba(0,0,0,0.9)]">
    <div className="flex items-center gap-2 border-b border-white/10 bg-white/[0.03] px-4 py-2.5">
      ...
      <span className="ml-1 text-xs text-white/40">{title}</span>
    </div>
