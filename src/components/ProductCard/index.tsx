...
export default async function Product({
  ...
  return (
    <Link
      href={`guias/${slug}`}
      className="group relative flex flex-col h-full bg-white rounded-xl overflow-hidden ring-1 ring-black/5 shadow-md transition-all duration-300 ease-out hover:-translate-y-1.5 hover:shadow-[0_20px_50px_-15px_rgba(238,192,72,0.35)] hover:ring-primary-300/40 md:max-w-[320px]"
    >
