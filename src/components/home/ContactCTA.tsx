        ...
        <div className={`${cardClass} p-8`}>
          ...
          <div className="flex items-center gap-5 mt-5 mb-5">
            ...
            <div>
              ...
              <p className="text-claude text-sm mt-0.5">
        ...
        >
          ...
          <div className="relative">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-white/90 mt-3 mb-4 leading-tight">
              ...
              <span className="text-claude">potenciar con IA</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
              <Link
                ...
                className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-lg bg-gradient-to-r from-claude-deep to-claude px-8 py-4 text-base font-bold text-white shadow-lg shadow-claude-deep/25 transition-transform duration-200 hover:scale-[1.02] hover:shadow-claude/40"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-lg border border-white/15 bg-white/[0.03] px-6 py-4 text-sm font-semibold text-white/80 transition-colors hover:border-claude/50 hover:text-white"
              >
                <Mail className="h-4 w-4 text-claude" />
                {CONTACT_EMAIL}
              </a>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-white/60">
              <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3.5 py-1.5">
                <Clock className="h-3.5 w-3.5 text-claude" />
                Respuesta en menos de 24 horas
              </span>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3.5 py-1.5">
                <ShieldCheck className="h-3.5 w-3.5 text-claude" />
                Sin compromiso
              </span>
            </div>
          </div>
