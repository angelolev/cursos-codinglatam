  ...
  return (
    <div className="container mx-auto px-4 pt-28 pb-24">
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row lg:items-start gap-8">
        ...
        {/* Right: Promo sidebar (stacks below on mobile/tablet) */}
        <div className="lg:w-72 lg:sticky lg:top-28 shrink-0 text-center lg:text-left mt-8 lg:mt-0">
          <h3 className="text-xl font-bold text-white/90 mb-3 leading-snug">
            Aprende a dominar Claude Code desde cero y certifícate.
          </h3>
          <p className="text-white/60 text-sm mb-6">
            ¿Todavía no usas Claude Code? Es la herramienta que está cambiando
            cómo programan los mejores equipos del mundo. Aprende en español, en
            vivo, desde cero.
          </p>
          <Link
            href="/claude"
            className="inline-flex items-center gap-2 px-6 py-3 bg-primary-300 text-white text-sm rounded-md font-medium hover:bg-primary-400 transition-colors"
          >
            Quiero ser parte
          </Link>
        </div>
