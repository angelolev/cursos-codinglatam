...
export default function ClaudeNegociosPage() {
  ...
  const teLlevas = [
    "Tus plantillas de trabajo y tu voz de marca capturada",
    "Al menos una tarea repetitiva convertida en Skill",
    "Un flujo real automatizado con tus propias herramientas",
    "Criterio para saber cuándo la IA se está equivocando",
    "Una política mínima de datos para ti o tu equipo",
    "Certificado verificable de Coding Latam",
  ];
