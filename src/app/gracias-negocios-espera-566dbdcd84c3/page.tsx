...
// de pago" (ej. PagoEfectivo, transferencia). No hay una verificación real
// (cualquiera con el link exacto podría entrar), así que no debe ser la
// única defensa.
...
export default function GraciasClaudeNegociosEsperaPage() {
  return (
    <main className="pt-24 pb-16 mx-auto w-full max-w-2xl sm:px-6 px-4 flex-grow min-w-0 text-center">
      <div className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-claude-deep/15 border border-claude-deep/30 mb-6">
        <Clock className="h-8 w-8 text-claude" />
      </div>
      ...
      <p className="text-white/60 mb-10">
        Elegiste un método de pago que Hotmart necesita confirmar (por
        ejemplo PagoEfectivo o transferencia). Apenas se acredite, tu
        inscripción a Claude para Negocios queda lista automáticamente.
      </p>
      ...
      <div className={`${cardClass} p-6 sm:p-8 mb-10`}>
        ...
        <p className="text-sm text-white/60">
          En cuanto Hotmart confirme el pago, te llega un correo con la
